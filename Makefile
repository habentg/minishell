...
#    Updated: 2023/11/15 06:54:28 by hatesfam         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_FILES = src/minishell.c  src/init_minishell.c src/signal.c\
			...
			$(EXPANDER_DIR)/var_expander.c $(EXPANDER_DIR)/var_expander_utils_2.c $(EXPANDER_DIR)/var_expander_utils.c $(EXPANDER_DIR)/expand_utils.c $(EXPANDER_DIR)/remove_qoutes.c\
